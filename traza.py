# -*- coding: utf-8 -*-
"""
Created on Wed Jun 21 13:01:44 2023
...
import psycopg2
import busca_actos as busca_actos
...
cursor1.execute("""
                select  cast(fecha_expedicion as date)
...
def traza(titulo, lvl_down, node_pos, G):
    ...
    #REVISADO CON DOS OPCIONES
    cursor1.execute("""
       select numero_titulo, fecha_expedicion, superficie, cc.nombre, nombre_lote
    from dgm.concesion c
    ...
    cursor1.execute("""
                ...
                from dgm.concesion_lotes_sustituidos ls
                inner join dgm.concesion c on ls.id_concesion = c.id_concesion
                where c.numero_titulo = '"""+str(titulo)+"""'
                    """)
    ...
    if len(relation) == 1:
        ...
        cursor1.execute("""
                ...
                --ls.numero_titulo puede ser varchar
                        """)
        dd = cursor1.fetchall()
...
plt.savefig("C:/Users/carlo/Documents/trazabilidad_02/graficas/"+str(titulo)+".jpg", dpi=1000)  

img = Image.open("C:/Users/carlo/Documents/trazabilidad_02/graficas/"+str(titulo)+".jpg")
img.show()
